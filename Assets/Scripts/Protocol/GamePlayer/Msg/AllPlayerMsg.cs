...
public class AllPlayerMsg : BaseMsg
{
    public AllPlayerData playerData;
    public override int GetBytesNum()
    {
        int num = 8;
        num += playerData.CalculateSize();//获取长度
        return num;
    }
    public override byte[] Writing()
    {
        ...
        byte[] bs = ProtobufTool.GetProtoBytes(playerData);
    ...
    public override int Reading(byte[] bytes, int beginIndex = 0)
    {
        ...
        playerData = ProtobufTool.GetProtoType<AllPlayerData>(bytes);
    ...
    public override int Reading(byte[] bytes, int dataBytesLength, int beginIndex = 0)
    {
        ...
        playerData = ProtobufTool.GetProtoType<AllPlayerData>(bt);
        return index - beginIndex;
    }
