...
public class MsgPool
{
	...
	public MsgPool()
	{
        ...
        Register(1004, typeof(InputMsg), typeof(InputMsgHandler));
        Register(1005, typeof(AllInputMsg), typeof(AllInputMsgHandler));
        Register(1006, typeof(AllPlayerMsg), typeof(AllPlayerMsgHandler));
        Register(1010, typeof(JoinRoomMsg), typeof(JoinRoomMsgHandler));
        Register(1011, typeof(RoomStateMsg), typeof(RoomStateMsgHandler));
        Register(1012, typeof(PlayerReadyMsg), typeof(PlayerReadyMsg));
        Register(1013, typeof(BattleReadyMsg), typeof(BattleReadyMsgHandler));
        Register(1014, typeof(GameStartMsg), typeof(GameStartMsgHandler));
    }
